...
class ForgejoCliUser:
    ...
    def add_user(
        ...
        args_list += ["--username", username, "--password", password, "--email", email]
        ...
        if rc == 0:
            return dict(
                failed=False, changed=True, msg=f"user {username} successful created."
            )
        else:
    ...
    def check_existing_users(
        self, new_users: List[dict], existing: dict
